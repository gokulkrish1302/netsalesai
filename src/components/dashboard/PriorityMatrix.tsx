        ...
        <div className="mb-1 flex items-center gap-2">
          ...
          <UITooltip>
            ...
            <TooltipContent side="left" className="max-w-xs text-xs">
              Top-right is your sweet spot: high score, urgent renewal. Bubble size = IT budget. Click any bubble for the full account profile.
            </TooltipContent>
          </UITooltip>
        </div>
        <p className="mb-4 text-xs text-muted-foreground">
          Where to spend your time this week · {scoredAccounts.length} accounts plotted
        </p>
        ...
        <div className="relative flex-1">
          ...
          <div className="pointer-events-none absolute inset-0 z-10 p-8">
            <div className="relative h-full w-full">
              <span className="absolute right-2 top-2 text-[10px] font-bold uppercase tracking-wider" style={{ color: "#FCA5A5" }}>
                Act now
              </span>
              <span className="absolute left-2 top-2 text-[10px] font-bold uppercase tracking-wider" style={{ color: "#FCD9A5" }}>
                Nurture fast
              </span>
              <span className="absolute right-2 bottom-2 text-[10px] font-bold uppercase tracking-wider" style={{ color: "#A5C2FC" }}>
                High potential
              </span>
              <span className="absolute left-2 bottom-2 text-[10px] font-bold uppercase tracking-wider" style={{ color: "#C8CDD3" }}>
                Monitor
              </span>
            </div>
          </div>
            ...
            <ScatterChart margin={{ top: 20, right: 24, bottom: 32, left: 24 }}>
              ...
              <XAxis
                ...
                label={{
                  ...
                  offset: -16,
                  style: { fontSize: 10, fill: "var(--muted-foreground)", letterSpacing: "0.04em", textTransform: "uppercase" },
                }}
              />
              <YAxis
                type="number"
...
function MatrixTooltip({ active, payload }: { active?: boolean; payload?: Array<{ payload: Point }> }) {
  ...
  return (
    <div className="rounded-2xl bg-card p-3 text-xs" style={{ minWidth: 220, boxShadow: "var(--elevation-3)" }}>
